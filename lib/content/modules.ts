...
export const BASE_MODULE_PAGES: ModulePage[] = [
  ...
  },
  {
    ...
    lead:
      "Позиции по объемным ядрам, история срезов и отчёт для клиента — в одной панели.",
  ...
  },
  {
    ...
    h1: "Проверка позиций сайта по ключевым запросам",
    description:
      "Лендинг мониторинга: панель, три акта от ядра до отчёта, боль vs решение, экосистема модулей.",
    lead:
      "Позиции по объемным ядрам, история срезов и отчёт для клиента — в одной панели.",
    features: ["Анализ ТОП-100", "Анализ конкурентов"],
  },
  ...
  },
  {
    ...
    description:
      "Семантика из подсказок Яндекс и Google: длинный, коммерческий и локальный хвост. Для продвижения, контента и контекста — демо на сайте, полный сбор и выгрузка в кабинете.",
    lead:
      "Подсказки показывают, как люди дописывают запрос. Соберите хвост для ядра, ТЗ и кластеризации — без ручного клика по алфавиту.",
  ...
  },
  {
    ...
    path: "/zapisi-domena/",
    title: "Записи домена",
    h1: "Записи домена: регистрация и DNS",
    description:
      "Сведения о регистрации домена, DNS-записи и соседи по адресу одним отчётом. Демо на сайте; в кабинете — история снимков, сравнение и связка с мониторингом сайтов и сроком регистрации.",
    lead:
      "Проверьте занятость, срок, серверы имён и DNS (A, MX, TXT…). Сразу видно адрес и кто ещё на нём — удобно для аудита хостинга.",
    features: ["Регистрация и DNS", "Соседи по адресу", "История и сравнение", "Лимиты по тарифу"],
  },
  {
    slug: "tipy-saitov-v-vydache",
    path: "/tipy-saitov-v-vydache/",
    title: "Типы сайтов в выдаче",
    h1: "Типы сайтов в выдаче Яндекс и Google",
    description:
      "Срез выдачи по типам сайтов: агрегаторы, магазины, организации, контент. Демо на сайте; в кабинете — список фраз, обе ПС, глубина и история.",
    lead:
      "По фразе видно характер выдачи — коммерция, информация или смесь. Помогает выбрать формат посадочной до глубокого анализа конкурентов.",
  ...
  },
  {
    ...
    description:
      "Оценка фразы по трём метрикам: геозависимость, локализация и коммерция. Демо на сайте; в кабинете — список фраз, регионы и история.",
    lead:
      "По фразе видно, зависит ли выдача от региона, насколько она местная и насколько коммерческая — до ТЗ и анализа конкурентов.",
