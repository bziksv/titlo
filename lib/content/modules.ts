...
export const BASE_MODULE_PAGES: ModulePage[] = [
  ...
  },
  {
    ...
    h1: "Мониторинг мета-тегов вашего сайта с автоматическими проверками и историей изменений",
    description:
      "Проверьте title, description, H1 и canonical по списку страниц. Результаты сохраняются в кабинете: история снимков, проверки по графику и уведомления об изменениях.",
    lead:
      "Проверьте title, description, H1 и canonical по вашему списку страниц. Результаты проверки сохраняются в кабинете для контроля версий и оперативного отслеживания изменений.",
    features: [
      "До 500 URL",
  ...
  },
  {
    ...
    h1: "Проверка текста Есенин — риск до публикации",
    description:
      "Проверка SEO-текста на риск «Баден-Баден»: повторы, стилистика, запросы, водность и удобочитаемость. Подсветка, балл и правки до публикации — в кабинете с HTML-редактором и 6 вкладками.",
    lead:
      "SEO-текст на риск до публикации: шесть категорий, подсветка и подсказки. Демо — сводный отчёт; в кабинете — редактор, вкладки и правки в результате.",
