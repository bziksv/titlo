...
export const MODULE_NAV_BASE: readonly ModuleNavItem[] = [
  ...
  { slug: "monitoring-pozicii-sayta", label: "Мониторинг позиций сайта", flagship: true },
  { slug: "monitoring-saytov", label: "Мониторинг корректной работы сайтов", flagship: true },
  ...
  { slug: "proverka-teksta-esenin", label: "Проверка текста Есенин", flagship: true },
  { slug: "sbor-poiskovykh-podskazok", label: "Сбор поисковых подсказок", flagship: true },
