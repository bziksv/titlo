...
function patchRecommendationRules(html) {
  ...
  const thirdPartyExtras = [
    ...
    '<li><a href="https://top-fwz1.mail.ru/">https://top-fwz1.mail.ru/</a> — сервис Top.Mail.Ru (пиксель VK Рекламы); используется на сайте titlo.ru и в личном кабинете cabinet.titlo.ru для сбора и анализа статистики посещений, действий пользователей и достижения рекламных целей.</li>',
  ].join("");
  ...
  if (!out.includes("https://top-fwz1.mail.ru/")) {
    out = out.replace(
      /(<li><a href="https:\/\/cdnjs\.cloudflare\.com\/">https:\/\/cdnjs\.cloudflare\.com\/<\/a>[^<]*<\/li>)/gi,
      `$1<li><a href="https://top-fwz1.mail.ru/">https://top-fwz1.mail.ru/</a> — сервис Top.Mail.Ru (пиксель VK Рекламы); используется на сайте titlo.ru и в личном кабинете cabinet.titlo.ru для сбора и анализа статистики посещений, действий пользователей и достижения рекламных целей.</li>`,
    );
  }
